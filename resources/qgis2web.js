...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [155394.754974, 100369.247829, 158072.338310, 101790.060330], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:28191',
            extent: [150208.574067, 100116.569172, 156819.687500, 101707.637600],
            units: 'm'})
    })
});
...
map.getView().fit([155394.754974, 100369.247829, 158072.338310, 101790.060330], map.getSize());
